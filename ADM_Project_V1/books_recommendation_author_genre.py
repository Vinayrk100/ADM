...
def recommend_books_author(userID):
    ...
    recommendations = (books_details_df[~books_details_df['book_id'].isin(user_full['book_id']) &
                                        books_details_df['book_authors'].isin(authors) &
...
predictions.to_csv('C:/Users/Nikhita/Desktop/Dataset/Final/Output/author_genre_books_predictions_svd.csv')
already_rated.to_csv('C:/Users/Nikhita/Desktop/Dataset/Final/Output/author_genre_books_already_rated_svd.csv')
